...
To begin, the binding energies of FQCT are extremely accurate compared to its reference method. Indeed, the largest error is 0.7 kcal/mol for \ce{F^-(H_2O)}, which is by far the most difficult case. The rest of the ions have binding energies accurate to wi
