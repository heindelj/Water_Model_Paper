...
\begin{figure}[h]
  ...
  for \ce{F^-}, \ce{Cl^-}, \ce{Br^-}, and \ce{I^-}, respectively. The 3-body charge transfer MAEs over
  the trimers in panel B are 0.129, 0.068, 0.056, and 0.044 kcal/mol
  for \ce{F^-}, \ce{Cl^-}, \ce{Br^-}, and \ce{I^-}, respectively.
}
  \label{fig:halide_3b}
\end{figure}
...
\begin{figure}[h]
  ...
  0.123, and 0.078 kcal/mol for \ce{Li^+}, \ce{Na^+}, \ce{K^+}, \ce{Rb^+}, and \ce{Cs^+},
